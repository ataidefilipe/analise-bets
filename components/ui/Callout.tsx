...
export function Callout({ children }: CalloutProps) {
  return (
    <div className="flex gap-3 rounded-md border border-zinc-300 border-l-4 border-l-accent bg-zinc-50 px-4 py-3 text-sm text-zinc-700 dark:border-zinc-700 dark:border-l-accent dark:bg-zinc-900 dark:text-zinc-300">
