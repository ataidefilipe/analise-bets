...
| Componente | Para quê |
| :--- | :--- |
| `FiltrosAgregado` | Alterna entre agregação "por clube" e "por rodada", e filtra por competição. |
...
Nenhum tipo em `lib/types/agregado.ts` tem campo de atleta, e a agregação
(`lib/mock/agregados.ts`) soma só contagens por clube/rodada. Qualquer PR
