...
3. **Aferição contra o Ground-Truth da Operação Penalidade Máxima:** Sensibilidade de **42,9% (6 de 14 incidentes sinalizados)**, captura que **não se distingue de seleção aleatória** no nível da partida (Tabela 21). O classificador de ML, avaliado fora da amostra, não generaliza (Tabela 22);
