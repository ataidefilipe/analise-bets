...
- Tabelas analíticas e dados do Ground Truth da Operação Penalidade Máxima
...
def generate_html():
    print("Iniciando montagem da apresentação HTML completa e enriquecida...")
...
"""
    ...
    print(f"Apresentação HTML gerada com sucesso em: {OUTPUT_HTML}")
