    ...
    <main class="main-content" id="mainContainer">
      ...
      <section class="slide" id="phase-9">
        ...
        <div class="alert-box success">
          <div class="alert-title">📚 Fichamento Teórico e Literatura Seminal (docs/arquivo/revisao_bibliografica.md)</div>
          <p>
      ...
      <section class="slide" id="risks-checklist">
        ...
        <div class="checklist-container">
          ...
          <div class="checklist-item">
            <input type="checkbox" checked disabled>
            <div><strong>Dados:</strong> Origem documentada em <code>docs/arquivo/sources.md</code> e dicionário de dados em <code>docs/data_dictionary.md</code> com hashes SHA-256.</div>
          </div>
          <div class="checklist-item">
            <input type="checkbox" checked disabled>
        ...
        <div class="alert-box success" style="margin-top:2rem;">
          ...
          <p>
            ...
            os casos de manipulação por micro-apostas constituem desvios criminosos individuais — e é justamente por serem individuais que o índice de partida, que mede distorção coletiva, não consegue prioriza-los. A unidade de análise com sinal é o atleta.
          </p>
        </div>
      </section>
