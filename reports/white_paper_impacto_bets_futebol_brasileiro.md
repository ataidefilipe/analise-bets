...
8. **O desencontro é de unidade de análise.** O índice de partida mede distorção coletiva; os
   incidentes conhecidos são atos individuais. É o mesmo achado da econometria deste trabalho,
   que estima efeito **nulo** da exposição sobre a proporção coletiva de cartões no 1º tempo
   ($\beta = -0{,}0129$, $p = 0{,}5916$): a manipulação por micro-apostas é conduta individual,
   não comportamento de clube. O caminho com evidência é o nível do atleta.
